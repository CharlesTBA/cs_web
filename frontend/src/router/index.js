...
const routes = [
  ...
  { path: '/core-values', name: 'CoreValues', component: CoreValues },
  { path: '/philosophy', name: 'Philosophy', component: Philosophy },
  { path: '/symbols', name: 'Symbols', component: Symbols },
  { path: '/hymn', name: 'Hymn', component: Hymn }
    ,{ path: '/vision-mission', name: 'VisionMission', component: VisionMission }
  ,{ path: '/grades', name: 'Grades', component: GradesList }
  ,{ path: '/subjects', name: 'Subjects', component: SubjectsList }
]
